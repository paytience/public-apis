...
← [Events](./events.md) | [Food & Drink](./food-and-drink.md) →
...
| [Bango Direct Billing](https://support.bango.com/entries/23400666-Direct-Billing-web-service-API-In-app-billing-without-the-need-to-open-a-browser) | Bangoâ€™s Direct Billing API is designed to allow mobile applications and web sites to request... | No | Yes |  | Unknown |
...
| [CompraFÃ¡cil](https://hm.comprafacil.pt/SIBSClick/webservice/clicksmsV4.asmx?) | CompraFÃ¡cil provides a payment platform that allows any member company (Partner) to generate... | No | Yes |  | Unknown |
...
| [Facturar en LÃ­nea Remote Connection](https://www.fel.mx/ConexionRemotaCFDI32/ConexionRemota32.asmx) | Facturar en LÃ­nea (FEL) provides Mexican companies with electronic billing services. | No | Yes |  | Unknown |
...
| [Mastercard MATCH](https://developer.mastercard.com/portal/display/api/MATCH) | Member Alert to Control High-risk Merchants (MATCH) is Mastercardâ€™s offering to acquirers for... | No | Yes |  | Unknown |
