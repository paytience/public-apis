...
← [Data Validation](./data-validation.md) | [Dictionaries](./dictionaries.md) →
...
| [Crossbar](https://ordbok.nada.kth.se) | TvÃ¤rslÃ¥ (trans. Crossbar) is a Nordic translation dictionary managed by the KTH Royal Institute... | No | Yes |  | Unknown |
...
| [Exversion](https://www.exversion.com/api) | Exversion is a data platform that crawls and indexes the worldâ€™s open data and makes it... | No | Yes |  | Unknown |
...
| [LeanKit Kanban](https://support.leankit.com/entries/20265038-api-basics) | LeanKit Kanban is an online tool that allows users to visualize their organizationâ€™s processes on... | No | Yes |  | Unknown |
...
| [Qirina](http://www.qirina.com/api.html) | Qirina is a database that represents a websitesâ€™ relations on a mapped out matrix of keywords. | No | Yes |  | Unknown |
...
| [SemanticHacker](https://textwise.com/api) | The SemanticHacker API generates Semantic Signaturesï¿½. | No | Yes |  | Unknown |
...
| [Yahoo Content Analysis](https://developer.yahoo.com/contentanalysis) | Yahoo Content Analysis replaces Yahoo!â€™s Term Extraction service and lets users perform content... | No | Yes |  | Unknown |
